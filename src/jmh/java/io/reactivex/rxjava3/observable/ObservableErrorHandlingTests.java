...
public class ObservableErrorHandlingTests extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_onNextError() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::onNextError, this.description("onNextError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onNextErrorAcrossThread() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onNextErrorAcrossThread, this.description("onNextErrorAcrossThread"));
        }

        private ObservableErrorHandlingTests implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableErrorHandlingTests();
        }

        @java.lang.Override
        public ObservableErrorHandlingTests implementation() {
