...
public class ObservableZipTests extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_zipObservableOfObservables() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::zipObservableOfObservables, this.description("zipObservableOfObservables"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_covarianceOfZip() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::covarianceOfZip, this.description("covarianceOfZip"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_nonBlockingObservable() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::nonBlockingObservable, this.description("nonBlockingObservable"), java.util.NoSuchElementException.class);
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_zipWithDelayError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::zipWithDelayError, this.description("zipWithDelayError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_zipWithDelayErrorBufferSize() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::zipWithDelayErrorBufferSize, this.description("zipWithDelayErrorBufferSize"));
        }

        private ObservableZipTests implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableZipTests();
        }

        @java.lang.Override
        public ObservableZipTests implementation() {
