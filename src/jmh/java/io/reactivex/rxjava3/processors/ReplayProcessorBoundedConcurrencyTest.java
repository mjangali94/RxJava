...
public class ReplayProcessorBoundedConcurrencyTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_replaySubjectConcurrentSubscribersDoingReplayDontBlockEachOther() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::replaySubjectConcurrentSubscribersDoingReplayDontBlockEachOther, this.description("replaySubjectConcurrentSubscribersDoingReplayDontBlockEachOther"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_replaySubjectConcurrentSubscriptions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::replaySubjectConcurrentSubscriptions, this.description("replaySubjectConcurrentSubscriptions"));
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_raceForTerminalState() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::raceForTerminalState, this.description("raceForTerminalState"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_replaySubjectEmissionSubscriptionRace() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::replaySubjectEmissionSubscriptionRace, this.description("replaySubjectEmissionSubscriptionRace"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_concurrentSizeAndHasAnyValue() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concurrentSizeAndHasAnyValue, this.description("concurrentSizeAndHasAnyValue"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_concurrentSizeAndHasAnyValueBounded() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concurrentSizeAndHasAnyValueBounded, this.description("concurrentSizeAndHasAnyValueBounded"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_concurrentSizeAndHasAnyValueTimeBounded() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concurrentSizeAndHasAnyValueTimeBounded, this.description("concurrentSizeAndHasAnyValueTimeBounded"));
        }

        private ReplayProcessorBoundedConcurrencyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ReplayProcessorBoundedConcurrencyTest();
        }

        @java.lang.Override
        public ReplayProcessorBoundedConcurrencyTest implementation() {
