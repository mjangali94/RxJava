...
public class UnicastProcessorTest extends FlowableProcessorTest<Object> {
    ...
    public void fusedNoConcurrentCleanDueToCancel() {
        for (int j = 0; j < TestHelper.RACE_LONG_LOOPS; j++) {
            ...
            try {
                final UnicastProcessor<Integer> up = UnicastProcessor.create();
                TestObserver<Integer> to = up.observeOn(Schedulers.io()).map(Functions.<Integer>identity()).observeOn(Schedulers.single()).firstOrError().test();
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.processors.FlowableProcessorTest.myBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_failFastFusionOffline() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::failFastFusionOffline, this.description("failFastFusionOffline"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_threeArgsFactory() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::threeArgsFactory, this.description("threeArgsFactory"));
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkTerminatedFailFastEmpty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkTerminatedFailFastEmpty, this.description("checkTerminatedFailFastEmpty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_alreadyCancelled() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::alreadyCancelled, this.description("alreadyCancelled"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unicastSubscriptionBadRequest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::unicastSubscriptionBadRequest, this.description("unicastSubscriptionBadRequest"));
        }
        ...
        private UnicastProcessorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new UnicastProcessorTest();
        }

        @java.lang.Override
        public UnicastProcessorTest implementation() {
