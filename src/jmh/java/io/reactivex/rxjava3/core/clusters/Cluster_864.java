   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.completable.CompletableOnErrorXTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_864() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.scanFunctionThrowsAndUpstreamCompletesDoesNotResultInTwoTerminalEvents.evaluate();
            this._Benchmark_benchmark_1.payloads.withCompletableDoubleOnSubscribe.evaluate();
            this._Benchmark_benchmark_0.payloads.scanFunctionThrowsAndUpstreamEmitsOnNextResultsInScanFunctionBeingCalledOnlyOnce.evaluate();
