...
public class Cluster_810 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.maybe.MaybeZipIterableTest._Benchmark _Benchmark_benchmark_5;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_5 = new io.reactivex.rxjava3.internal.operators.maybe.MaybeZipIterableTest._Benchmark();
        ...
        public void benchmark_Cluster_810() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.justDisposerCrashes.evaluate();
            this._Benchmark_benchmark_1.payloads.error.evaluate();
            this._Benchmark_benchmark_2.payloads.errorToMaybe.evaluate();
            this._Benchmark_benchmark_3.payloads.error.evaluate();
            this._Benchmark_benchmark_4.payloads.flatMapSingleElementValueNull.evaluate();
            this._Benchmark_benchmark_5.payloads.maybeSourcesInIterable.evaluate();
        }
