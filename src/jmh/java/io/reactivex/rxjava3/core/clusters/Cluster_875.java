    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableRepeatTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_875() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.timespanTimeskipCustomSchedulerBufferSize.evaluate();
            this._Benchmark_benchmark_1.payloads.repeatWhen.evaluate();
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.repeatWhen);
        }
