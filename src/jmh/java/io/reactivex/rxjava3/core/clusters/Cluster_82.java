   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWindowWithSizeTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_82() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.doubleOnSubscribe.evaluate();
            this._Benchmark_benchmark_1.payloads.fusedCombinerCrashError2.evaluate();
            this._Benchmark_benchmark_2.payloads.conditionalFusionNoNPE.evaluate();
            this._Benchmark_benchmark_3.payloads.skipMultipleRequests.evaluate();
        }
