...
public class Cluster_833 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWindowWithStartEndFlowableTest._Benchmark _Benchmark_benchmark_3;
       private io.reactivex.rxjava3.internal.jdk8.FlowableStageSubscriberOrErrorTest._Benchmark _Benchmark_benchmark_7;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_3 = new io.reactivex.rxjava3.internal.operators.flowable.FlowableWindowWithStartEndFlowableTest._Benchmark();
        ...
        public void benchmark_Cluster_833() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.subscribeConsumerConsumerWithError);
            this._Benchmark_benchmark_1.payloads.disposed.evaluate();
            this._Benchmark_benchmark_2.payloads.fromCompletable.evaluate();
            this._Benchmark_benchmark_3.payloads.mainError.evaluate();
            this._Benchmark_benchmark_2.payloads.fromCompletableInvokesLazy.evaluate();
            this._Benchmark_benchmark_2.payloads.fromCompletableTwice.evaluate();
            this._Benchmark_benchmark_2.payloads.cancelWhileRunning.evaluate();
            this._Benchmark_benchmark_7.payloads.firstError.evaluate();
        }
