   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableFlatMapCompletableTest._Benchmark _Benchmark_benchmark_0;
        ...
        public void benchmark_Cluster_46() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.normal.evaluate();
            this._Benchmark_benchmark_0.payloads.normalDelayError.evaluate();
            this._Benchmark_benchmark_0.payloads.fusedInternalsObservable.evaluate();
            this._Benchmark_benchmark_0.payloads.normalObservable.evaluate();
        }
