   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableFromIterableTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_371() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.iteratorHasNextThrowsImmediately.evaluate();
            this._Benchmark_benchmark_1.payloads.flatMapIterableMapperIterableOneNull.evaluate();
            this._Benchmark_benchmark_2.payloads.subscribeMultipleTimes.evaluate();
            this._Benchmark_benchmark_0.payloads.cancelAfterHasNext.evaluate();
            this._Benchmark_benchmark_0.payloads.failingInnerCancelsSource.evaluate();
            this._Benchmark_benchmark_2.payloads.hasNextCancelsAndCompletesFastPath.evaluate();
        }
