   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableTakeTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_804() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.checkTerminatedDelayErrorEmptyError.evaluate();
            this._Benchmark_benchmark_1.payloads.exactBackpressure.evaluate();
            this._Benchmark_benchmark_2.payloads.windowOpenMainCompletes.evaluate();
            this._Benchmark_benchmark_3.payloads.errorAfterLimitReached.evaluate();
        }
