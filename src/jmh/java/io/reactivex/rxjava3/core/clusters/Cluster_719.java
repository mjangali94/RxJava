    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.disposables.CompositeDisposableTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_719() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.innerDoubleOnError.evaluate();
            this._Benchmark_benchmark_1.payloads.clear.evaluate();
            this._Benchmark_benchmark_0.payloads.cancelAfterFirst.evaluate();
        }
