   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.maybe.MaybeTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_261() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.mapperThrowsWhenUpstreamErrors.evaluate();
            this._Benchmark_benchmark_1.payloads.overlapMoreWorkAfterOnNext.evaluate();
            this._Benchmark_benchmark_2.payloads.concatIterableBackpressuredNonEager.evaluate();
            this._Benchmark_benchmark_1.payloads.windowAbandonmentCancelsUpstreamSize.evaluate();
            this._Benchmark_benchmark_2.payloads.concat2BackpressuredNonEager.evaluate();
        }
