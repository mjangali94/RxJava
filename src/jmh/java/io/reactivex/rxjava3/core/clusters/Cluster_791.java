   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableOnBackpressureBufferTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_791() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.arrayDelayErrorMultipleErrors);
            this._Benchmark_benchmark_1.payloads.errorResubscribe.evaluate();
            this._Benchmark_benchmark_2.payloads.delayError.evaluate();
        }
