   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.completable.CompletableMergeTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_495() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.normalNonDelayErrorOuter.evaluate();
            this._Benchmark_benchmark_0.payloads.delayErrorMaxConcurrency.evaluate();
            this._Benchmark_benchmark_2.payloads.innerErrorDelayError.evaluate();
        }
