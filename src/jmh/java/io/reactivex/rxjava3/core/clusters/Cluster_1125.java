   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.subscribers.QueueDrainSubscriberTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_1125() throws java.lang.Throwable {
            
            this._Benchmark_benchmark_0.payloads.serialized.evaluate();
            this._Benchmark_benchmark_1.payloads.emitterHasToString.evaluate();
            this._Benchmark_benchmark_2.payloads.acceptBadRequest.evaluate();
        }
