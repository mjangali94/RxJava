    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableConcatMapSchedulerTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_188() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.delayEmitsEverything.evaluate();
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.singleInnerErrors);
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.mapperThrows);
        }
