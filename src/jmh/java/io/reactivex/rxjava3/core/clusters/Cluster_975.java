   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWithLatestFromTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_975() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.toListSupplierReturnsNull.evaluate();
            this._Benchmark_benchmark_0.payloads.generateFunctionStateNullAllowed.evaluate();
            this._Benchmark_benchmark_2.payloads.manyErrors.evaluate();
        }
