   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableGroupByTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_701() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.fusedInnerCrash.evaluate();
            this._Benchmark_benchmark_1.payloads.delayErrorCompleteMoreWorkInGroup.evaluate();
            this._Benchmark_benchmark_1.payloads.unsubscribeViaTakeOnGroupThenTakeOnInner.evaluate();
        }
