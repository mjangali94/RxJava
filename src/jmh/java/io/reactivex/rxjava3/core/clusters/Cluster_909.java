   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.completable.CompletableDisposeOnTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_909() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.bufferExactBoundarySecondBufferCrash.evaluate();
            this._Benchmark_benchmark_1.payloads.errorAfterCancel.evaluate();
        }
