   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_707() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.otherErrors.evaluate();
            this._Benchmark_benchmark_1.payloads.emptyHidden.evaluate();
            this._Benchmark_benchmark_2.payloads.bufferBoundarySupplierReturnsNull.evaluate();
        }
