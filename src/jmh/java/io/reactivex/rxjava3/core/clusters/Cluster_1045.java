    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.BlockingObservableToIteratorTest._Benchmark _Benchmark_benchmark_4;
        ...
        public void benchmark_Cluster_1045() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.abandonedGroupDispose.evaluate();
            this._Benchmark_benchmark_1.payloads.fusedPollCrash.evaluate();
            this._Benchmark_benchmark_2.payloads.asyncFusedBoundaryConditional.evaluate();
            this._Benchmark_benchmark_0.payloads.groupByShouldPropagateError.evaluate();
            this._Benchmark_benchmark_4.payloads.remove.evaluate();
            this._Benchmark_benchmark_2.payloads.asyncFusedConditional.evaluate();
        }
