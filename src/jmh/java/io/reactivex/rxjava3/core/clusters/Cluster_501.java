    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_501() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.firstJustError.evaluate();
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.concatArrayDelayErrorWithError);
            this._Benchmark_benchmark_2.payloads.shouldTimeoutIfOnNextNotWithinTimeout.evaluate();
            this._Benchmark_benchmark_3.payloads.errorFunctionReturnsNull.evaluate();
        }
