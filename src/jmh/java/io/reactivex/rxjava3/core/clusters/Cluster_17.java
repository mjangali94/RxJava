    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.observable.ObservableNullTests._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_17() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.withError.evaluate();
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.arrayDelayError);
            this._Benchmark_benchmark_2.payloads.distinctUntilChangedFunctionReturnsNull.evaluate();
        }
