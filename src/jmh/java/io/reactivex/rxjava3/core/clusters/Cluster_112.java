    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowablePublishFunctionTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_112() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_0.payloads.firstCompletableManualCompleteExceptionallyCancels.evaluate();
            this._Benchmark_benchmark_1.runBenchmark(this._Benchmark_benchmark_1.payloads.concatMapErrorEmptySource);
            this._Benchmark_benchmark_0.payloads.singleCompletableManualCompleteExceptionallyCancels.evaluate();
            this._Benchmark_benchmark_3.payloads.concatTakeFirstLastCompletes.evaluate();
        }
