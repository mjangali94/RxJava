   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableOnBackpressureBufferStrategyTest._Benchmark _Benchmark_benchmark_4;
        ...
        public void benchmark_Cluster_1064() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.singleTooManyCancels.evaluate();
            this._Benchmark_benchmark_1.payloads.singleTooManyCancels.evaluate();
            this._Benchmark_benchmark_2.payloads.nonNullConnection.evaluate();
