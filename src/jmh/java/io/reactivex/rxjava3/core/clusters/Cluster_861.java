   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.schedulers.ImmediateThinSchedulerTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_861() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.doubleOnSubscribe.evaluate();
            this._Benchmark_benchmark_1.payloads.replayTime.evaluate();
            this._Benchmark_benchmark_2.payloads.scheduleDirect.evaluate();
        }
