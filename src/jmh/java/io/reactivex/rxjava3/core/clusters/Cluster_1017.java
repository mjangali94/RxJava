...
public class Cluster_1017 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableZipTests._Benchmark _Benchmark_benchmark_3;
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_7;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_3 = new io.reactivex.rxjava3.flowable.FlowableZipTests._Benchmark();
        ...
        public void benchmark_Cluster_1017() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_1.payloads.disposedFlowable.evaluate();
            this._Benchmark_benchmark_2.payloads.fusionRejected.evaluate();
            this._Benchmark_benchmark_3.payloads.covarianceOfZip.evaluate();
            this._Benchmark_benchmark_4.payloads.flatMapBiMapperWithError.evaluate();
            this._Benchmark_benchmark_5.payloads.disposePropagates.evaluate();
            this._Benchmark_benchmark_6.payloads.withMainError.evaluate();
            this._Benchmark_benchmark_7.payloads.bufferSupplierReturnsNull.evaluate();
        }
