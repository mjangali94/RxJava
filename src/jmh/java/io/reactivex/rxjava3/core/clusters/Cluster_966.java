   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableRetryTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_966() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.undeliverableUponCancelDelayError.evaluate();
            this._Benchmark_benchmark_1.payloads.fusedNormal.evaluate();
            this._Benchmark_benchmark_1.payloads.nonFusedDelayErrorMoreWorkBeforeTermination.evaluate();
            this._Benchmark_benchmark_3.payloads.retryUntil.evaluate();
        }
