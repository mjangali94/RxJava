...
public class Cluster_162 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.mixed.FlowableConcatMapCompletableTest._Benchmark _Benchmark_benchmark_8;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_8 = new io.reactivex.rxjava3.internal.operators.mixed.FlowableConcatMapCompletableTest._Benchmark();
        ...
        public void benchmark_Cluster_162() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_0.payloads.nonFatalExceptionThrownByCombinatorForSingleSourceIsNotReportedByUpstreamOperator.evaluate();
            this._Benchmark_benchmark_1.payloads.dispose.evaluate();
            this._Benchmark_benchmark_2.payloads.allConcurrencyScalarInner.evaluate();
            this._Benchmark_benchmark_3.payloads.oneSourceOnly.evaluate();
            this._Benchmark_benchmark_4.payloads.deferFunctionReturnsNull.evaluate();
            this._Benchmark_benchmark_5.payloads.fusionRejected.evaluate();
            this._Benchmark_benchmark_2.payloads.flatMapBiMapperMaxConcurrency.evaluate();
            this._Benchmark_benchmark_4.payloads.publishFunctionReturnsNull.evaluate();
            this._Benchmark_benchmark_8.payloads.simple.evaluate();
        }
