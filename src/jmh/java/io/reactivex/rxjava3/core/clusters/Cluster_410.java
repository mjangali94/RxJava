   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWindowWithSizeTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_410() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.onErrorCrash.evaluate();
            this._Benchmark_benchmark_1.payloads.elementAtConstrainsUpstreamRequests.evaluate();
            this._Benchmark_benchmark_2.payloads.cancellingWindowCancelsUpstreamSize.evaluate();
        }
