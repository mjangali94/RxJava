    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowablePublishTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_999() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.backpressureOuterInexact.evaluate();
            this._Benchmark_benchmark_1.payloads.syncFusedNoRequest.evaluate();
            this._Benchmark_benchmark_1.payloads.subscriberSwap.evaluate();
            this._Benchmark_benchmark_1.payloads.subscriberLiveSwap.evaluate();
        }
