    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.jdk8.FlowableStageSubscriberOrDefaultTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_297() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.noCancelPreviousRepeatWhen);
            this._Benchmark_benchmark_1.payloads.firstSourceIgnoresCancel.evaluate();
            this._Benchmark_benchmark_2.payloads.firstSourceIgnoresCancel.evaluate();
        }
