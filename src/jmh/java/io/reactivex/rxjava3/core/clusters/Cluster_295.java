   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.jdk8.FlowableFlatMapStreamTest._Benchmark _Benchmark_benchmark_5;
        ...
        public void benchmark_Cluster_295() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.simpleInequal.evaluate();
            this._Benchmark_benchmark_1.payloads.interrupt.evaluate();
            this._Benchmark_benchmark_2.payloads.fusedInputCrash.evaluate();
            this._Benchmark_benchmark_3.payloads.dispose.evaluate();
            this._Benchmark_benchmark_4.payloads.connectIsIdempotent.evaluate();
            this._Benchmark_benchmark_5.payloads.streamNull.evaluate();
        }
