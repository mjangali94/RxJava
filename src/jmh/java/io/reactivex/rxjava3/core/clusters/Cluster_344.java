   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableWithLatestFromTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_344() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.pollThrows);
            this._Benchmark_benchmark_1.payloads.sourceThrows.evaluate();
            this._Benchmark_benchmark_1.payloads.otherThrows.evaluate();
        }
