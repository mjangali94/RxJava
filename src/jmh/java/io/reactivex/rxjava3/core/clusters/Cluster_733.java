   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_733() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.undeliverableUponCancelDelayError.evaluate();
            this._Benchmark_benchmark_1.payloads.retryWhenFunctionReturnsNull.evaluate();
        }
