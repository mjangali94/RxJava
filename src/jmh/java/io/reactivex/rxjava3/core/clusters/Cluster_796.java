    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableReplayTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_796() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.concatTakeFirstLastCompletes.evaluate();
            this._Benchmark_benchmark_1.payloads.selectorLatecommer.evaluate();
            this._Benchmark_benchmark_2.payloads.valuesAndThenError.evaluate();
            this._Benchmark_benchmark_3.payloads.valuesAndThenError.evaluate();
            this._Benchmark_benchmark_0.payloads.concatTakeFirstLastBackpressureCompletes.evaluate();
