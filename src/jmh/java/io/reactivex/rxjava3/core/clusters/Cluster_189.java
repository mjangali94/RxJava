    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.maybe.MaybeTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_189() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.valuesAndThenError.evaluate();
            this._Benchmark_benchmark_1.payloads.valuesAndThenError.evaluate();
            this._Benchmark_benchmark_2.runBenchmark(this._Benchmark_benchmark_2.payloads.fusedCrash);
            this._Benchmark_benchmark_3.payloads.fromObservableMany.evaluate();
        }
