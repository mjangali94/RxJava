   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.jdk8.ObservableStageSubscriberOrDefaultTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_409() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.collectorFailureDoesNotResultInTwoErrorEmissions.evaluate();
            this._Benchmark_benchmark_1.payloads.singleSourceIgnoresCancel.evaluate();
        }
