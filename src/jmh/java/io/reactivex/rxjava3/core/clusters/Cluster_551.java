   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableGroupByTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_551() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.windowUnsubscribeOverlapping.evaluate();
            this._Benchmark_benchmark_1.payloads.fusedSourceCrashResumeWithNextSource.evaluate();
            this._Benchmark_benchmark_2.payloads.clearIsEmpty.evaluate();
            this._Benchmark_benchmark_3.payloads.reentrantComplete.evaluate();
        }
