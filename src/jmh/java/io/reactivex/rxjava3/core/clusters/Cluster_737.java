   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.maybe.MaybeOnErrorXTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_737() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.onErrorNull.evaluate();
            this._Benchmark_benchmark_1.payloads.onErrorCompleteFalse.evaluate();
            this._Benchmark_benchmark_1.payloads.onErrorReturn.evaluate();
        }
