    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableConcatMapSchedulerTest._Benchmark _Benchmark_benchmark_6;
        ...
        public void benchmark_Cluster_192() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.flatMapFunctionReturnsNull.evaluate();
            this._Benchmark_benchmark_0.payloads.delayWithFunctionReturnsNull.evaluate();
            this._Benchmark_benchmark_2.payloads.empty2.evaluate();
            this._Benchmark_benchmark_3.payloads.empty.evaluate();
            this._Benchmark_benchmark_4.payloads.flatMapBiMapperWithError.evaluate();
            this._Benchmark_benchmark_0.payloads.flatMapCombinerMapperReturnsNull.evaluate();
            this._Benchmark_benchmark_6.runBenchmark(this._Benchmark_benchmark_6.payloads.concatMapDelayError);
        }
