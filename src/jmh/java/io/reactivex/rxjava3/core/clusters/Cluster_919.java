   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.exceptions.OnErrorNotImplementedExceptionTest._Benchmark _Benchmark_benchmark_3;
        ...
        public void benchmark_Cluster_919() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.exactWindowSize.evaluate();
            this._Benchmark_benchmark_1.payloads.badSourceOnSubscribe.evaluate();
            this._Benchmark_benchmark_2.payloads.onlyFirstShouldSubscribeAndLastUnsubscribe.evaluate();
            this._Benchmark_benchmark_3.payloads.observableBlockingSubscribe1.evaluate();
        }
