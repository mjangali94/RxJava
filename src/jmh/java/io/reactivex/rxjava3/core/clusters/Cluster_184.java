    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableDoAfterNextTest._Benchmark _Benchmark_benchmark_4;
        ...
        public void benchmark_Cluster_184() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_0.payloads.predicateThrowsExceptionAndValueInCauseMessage.evaluate();
            this._Benchmark_benchmark_1.payloads.mergePublisher.evaluate();
            this._Benchmark_benchmark_2.payloads.errorDelayed2.evaluate();
            this._Benchmark_benchmark_3.payloads.streamCloseCrash.evaluate();
            this._Benchmark_benchmark_4.payloads.asyncFusedRejected.evaluate();
        }
