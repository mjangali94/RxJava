   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWithLatestFromTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_679() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.backpressureWithBufferDropLatest.evaluate();
            this._Benchmark_benchmark_1.payloads.syncFusedAllConditional.evaluate();
            this._Benchmark_benchmark_2.payloads.backpressureWithSignal.evaluate();
            this._Benchmark_benchmark_1.payloads.syncFusedMixedConditional.evaluate();
        }
