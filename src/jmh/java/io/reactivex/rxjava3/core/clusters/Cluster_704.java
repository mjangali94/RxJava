    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_704() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_1.payloads.issue3008RetryWithPredicate.evaluate();
            this._Benchmark_benchmark_2.payloads.scanFunctionReturnsNull.evaluate();
            this._Benchmark_benchmark_1.payloads.issue3008RetryInfinite.evaluate();
        }
