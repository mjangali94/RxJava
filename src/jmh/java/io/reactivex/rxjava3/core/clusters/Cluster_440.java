...
public class Cluster_440 {
   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableConcatWithMaybeTest._Benchmark _Benchmark_benchmark_4;
       private io.reactivex.rxjava3.internal.operators.maybe.MaybeMergeArrayTest._Benchmark _Benchmark_benchmark_5;
       private io.reactivex.rxjava3.internal.jdk8.MaybeFlattenStreamAsFlowableTest._Benchmark _Benchmark_benchmark_6;
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableGenerateTest._Benchmark _Benchmark_benchmark_8;
        ...
        public void makePayloads() {
            ...
            _Benchmark_benchmark_4 = new io.reactivex.rxjava3.internal.operators.flowable.FlowableConcatWithMaybeTest._Benchmark();
            _Benchmark_benchmark_5 = new io.reactivex.rxjava3.internal.operators.maybe.MaybeMergeArrayTest._Benchmark();
            _Benchmark_benchmark_6 = new io.reactivex.rxjava3.internal.jdk8.MaybeFlattenStreamAsFlowableTest._Benchmark();
        ...
        public void benchmark_Cluster_440() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.error.evaluate();
            this._Benchmark_benchmark_1.payloads.fromFlowableJust.evaluate();
            this._Benchmark_benchmark_2.payloads.requestBeforeSuccess.evaluate();
            this._Benchmark_benchmark_3.runBenchmark(this._Benchmark_benchmark_3.payloads.noCancelPreviousArray);
            this._Benchmark_benchmark_4.payloads.mainError.evaluate();
            this._Benchmark_benchmark_5.payloads.mergeBadSource.evaluate();
            this._Benchmark_benchmark_6.payloads.fusedStreamAvailableLater.evaluate();
            this._Benchmark_benchmark_7.payloads.collectorFailureDoesNotResultInErrorAndOnNextEmissionsFlowable.evaluate();
