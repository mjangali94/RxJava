    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.flowable.FlowableNullTests._Benchmark _Benchmark_benchmark_5;
        ...
        public void benchmark_Cluster_215() throws java.lang.Throwable {
            ...
            this._Benchmark_benchmark_0.payloads.errorToMaybe.evaluate();
            this._Benchmark_benchmark_1.payloads.error.evaluate();
            this._Benchmark_benchmark_2.payloads.error.evaluate();
            this._Benchmark_benchmark_3.payloads.producerRequestThroughAmb.evaluate();
            this._Benchmark_benchmark_4.payloads.backpressuredEmpty.evaluate();
            this._Benchmark_benchmark_5.payloads.mapReturnsNull.evaluate();
        }
