    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.disposables.CompositeDisposableTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_215() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.firstErrors.evaluate();
            this._Benchmark_benchmark_1.payloads.crashReported.evaluate();
            this._Benchmark_benchmark_2.payloads.disposeThrowsError.evaluate();
        }
