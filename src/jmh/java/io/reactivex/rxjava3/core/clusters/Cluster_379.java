    ...
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.schedulers.SchedulerWhenTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_379() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.mainIgnoresCancelBeforeOnError.evaluate();
            this._Benchmark_benchmark_1.payloads.innerDisposed.evaluate();
            this._Benchmark_benchmark_2.payloads.subscribedDisposable.evaluate();
        }
