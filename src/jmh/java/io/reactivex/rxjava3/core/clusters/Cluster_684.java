   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableWindowWithFlowableTest._Benchmark _Benchmark_benchmark_2;
        ...
        public void benchmark_Cluster_684() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.undeliverableUponCancelDelayError.evaluate();
            this._Benchmark_benchmark_1.payloads.onNextSlowPath.evaluate();
            this._Benchmark_benchmark_2.payloads.boundaryDirectSecondMissingBackpressure.evaluate();
        }
