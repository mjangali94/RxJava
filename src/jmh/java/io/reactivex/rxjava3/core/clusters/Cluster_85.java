   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.observable.ObservableMergeDelayErrorTest._Benchmark _Benchmark_benchmark_1;
        ...
        public void benchmark_Cluster_85() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.payloads.maxConcurrencySustained.evaluate();
            this._Benchmark_benchmark_1.payloads.mergeDelayErrorWithError.evaluate();
            this._Benchmark_benchmark_1.payloads.mergeIterableDelayErrorMaxConcurrency.evaluate();
        }
