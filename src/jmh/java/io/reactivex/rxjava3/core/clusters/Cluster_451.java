   ...
   @org.openjdk.jmh.annotations.State(org.openjdk.jmh.annotations.Scope.Thread)
    public static class _Benchmark {
       ...
       private io.reactivex.rxjava3.internal.operators.flowable.FlowableRepeatTest._Benchmark _Benchmark_benchmark_4;
        ...
        public void benchmark_Cluster_451() throws java.lang.Throwable {
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.concatMapEmptyDelayError);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.fusedCrash);
            this._Benchmark_benchmark_0.runBenchmark(this._Benchmark_benchmark_0.payloads.immediateInnerNextOuterError2);
            this._Benchmark_benchmark_3.payloads.issue2826.evaluate();
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.noCancelPreviousRepeat);
            this._Benchmark_benchmark_4.runBenchmark(this._Benchmark_benchmark_4.payloads.noCancelPreviousRepeatUntil);
        }
