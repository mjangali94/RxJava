...
public final class ConverterTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_flowableConverterThrows() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::flowableConverterThrows, this.description("flowableConverterThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_observableConverterThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::observableConverterThrows, this.description("observableConverterThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_singleConverterThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::singleConverterThrows, this.description("singleConverterThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_maybeConverterThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::maybeConverterThrows, this.description("maybeConverterThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_completableConverterThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::completableConverterThrows, this.description("completableConverterThrows"));
        }
        ...
        public void benchmark_parallelFlowableGenericsSignatureTest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::parallelFlowableGenericsSignatureTest, this.description("parallelFlowableGenericsSignatureTest"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_compositeTest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::compositeTest, this.description("compositeTest"));
        }

        private ConverterTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ConverterTest();
        }

        @java.lang.Override
        public ConverterTest implementation() {
