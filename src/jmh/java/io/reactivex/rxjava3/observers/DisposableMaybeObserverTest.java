...
public class DisposableMaybeObserverTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        private DisposableMaybeObserverTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DisposableMaybeObserverTest();
        }

        @java.lang.Override
        public DisposableMaybeObserverTest implementation() {
