...
public class FutureDisposableTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_interruptible() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::interruptible, this.description("interruptible"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_normalDone() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::normalDone, this.description("normalDone"));
        }

        private FutureDisposableTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FutureDisposableTest();
        }

        @java.lang.Override
        public FutureDisposableTest implementation() {
