...
public class JavadocCodesAndLinks {
                    ...
                    for (int j = 0; j < docs.size(); j++) {
                        ...
                        if (seenBefore) {
                            ...
                            if (isHostType) {
                                if (idxLink >= 0) {
                                    errorCount++;
                                    errors.append("The host type mention should be code: ").append("{@code ").append(name).append("}\r\n at ").append(packageName).append(".").append(baseClassName).append(".method(").append(baseClassName).append(".java:").append(i + 2 + j).append(")\r\n");
                                }
                            } else {
                                if ((idxLink < 0 && idxCode >= 0 && !isAlwaysCode) || (idxLink >= 0 && idxCode >= 0 && idxCode < idxLink)) {
                                    errorCount++;
                                    if (isAlwaysCode) {
                                        errors.append("The first mention should be code: ").append("{@code ");
                                    } else {
                                        errors.append("The first mention should be link: ").append("{@link ");
                                    }
    ...
    public static class myBenchmark extends JU2JmhBenchmark {
        ...
        private JavadocCodesAndLinks implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new JavadocCodesAndLinks();
        }

        @java.lang.Override
        public JavadocCodesAndLinks implementation() {
