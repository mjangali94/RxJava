...
public class JavadocForAnnotations {
    ...
    public static class myBenchmark extends JU2JmhBenchmark {
        ...
        public void benchmark_checkFlowableBackpressure() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkFlowableBackpressure, this.description("checkFlowableBackpressure"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkFlowableScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkFlowableScheduler, this.description("checkFlowableScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkObservableBackpressure() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkObservableBackpressure, this.description("checkObservableBackpressure"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkObservableScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkObservableScheduler, this.description("checkObservableScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSingleBackpressure() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSingleBackpressure, this.description("checkSingleBackpressure"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSingleScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSingleScheduler, this.description("checkSingleScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkCompletableBackpressure() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkCompletableBackpressure, this.description("checkCompletableBackpressure"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkCompletableScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkCompletableScheduler, this.description("checkCompletableScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkMaybeBackpressure() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkMaybeBackpressure, this.description("checkMaybeBackpressure"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkMaybeScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkMaybeScheduler, this.description("checkMaybeScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkFlowableSchedulerDoc() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkFlowableSchedulerDoc, this.description("checkFlowableSchedulerDoc"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkObservableSchedulerDoc() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkObservableSchedulerDoc, this.description("checkObservableSchedulerDoc"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSingleSchedulerDoc() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSingleSchedulerDoc, this.description("checkSingleSchedulerDoc"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkCompletableSchedulerDoc() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkCompletableSchedulerDoc, this.description("checkCompletableSchedulerDoc"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkMaybeSchedulerDoc() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkMaybeSchedulerDoc, this.description("checkMaybeSchedulerDoc"));
        }

        private JavadocForAnnotations implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new JavadocForAnnotations();
        }

        @java.lang.Override
        public JavadocForAnnotations implementation() {
