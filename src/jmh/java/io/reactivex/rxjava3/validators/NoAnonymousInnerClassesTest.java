    ...
    public void verify() throws Exception {
        ...
        while (!queue.isEmpty()) {
            ...
            if (f.isDirectory()) {
                ...
                if (name.endsWith(".class") && name.contains("$") && !name.contains("Perf") && !name.contains("Test") && !name.startsWith("Test")) {
                                ...
                                if (content.contains("$SwitchMap$")) {
                                    ...
                                    for (File fsame : filesInTheSameDir) {
                                        ...
                                        if (fsameName.endsWith(".class")) {
                                            ...
                                            if (fsameName.startsWith(baseName) && fsameName.length() > baseName.length() + 1 && fsameName.charAt(baseName.length()) == '$' && Character.isDigit(fsameName.charAt(baseName.length() + 1))) {
                                                found = true;
                                                break;
                                            }
                                        }
