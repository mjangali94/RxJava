...
import io.reactivex.rxjava3.core.JU2JmhBenchmark;
...
public class JavadocWording {
    ...
    public static class myBenchmark extends JU2JmhBenchmark {
        ...
        public void benchmark_maybeDocRefersToMaybeTypes() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::maybeDocRefersToMaybeTypes, this.description("maybeDocRefersToMaybeTypes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_flowableDocRefersToFlowableTypes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::flowableDocRefersToFlowableTypes, this.description("flowableDocRefersToFlowableTypes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_parallelFlowableDocRefersToCorrectTypes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::parallelFlowableDocRefersToCorrectTypes, this.description("parallelFlowableDocRefersToCorrectTypes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_observableDocRefersToObservableTypes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::observableDocRefersToObservableTypes, this.description("observableDocRefersToObservableTypes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_singleDocRefersToSingleTypes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::singleDocRefersToSingleTypes, this.description("singleDocRefersToSingleTypes"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_completableDocRefersToCompletableTypes() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::completableDocRefersToCompletableTypes, this.description("completableDocRefersToCompletableTypes"));
        }

        private JavadocWording implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new JavadocWording();
        }

        @java.lang.Override
        public JavadocWording implementation() {
