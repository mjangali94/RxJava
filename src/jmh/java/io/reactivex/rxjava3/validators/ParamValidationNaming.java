...
public class ParamValidationNaming {
        ...
        for (int j = 0; j < lines.size(); j++) {
            ...
            for (ValidatorStrings validatorStr : VALIDATOR_STRINGS) {
                ...
                if (strIdx >= 0) {
                    ...
                    if (!line.contains("\"The RxJavaPlugins") && !(message.startsWith(paramName) && (message.endsWith(" ") || message.endsWith("\"")))) {
                        errorCount++;
                        errors.append("L").append(j).append(" : Wrong validator message parameter name\r\n    ").append(line).append("\r\n").append("    ").append(paramName).append(" != ").append(message).append("\r\n at ").append(fullClassName).append(".method(").append(f.getName()).append(":").append(j + 1).append(")\r\n");
                    }
                    int midx = j - 1;
                    // find the method declaration
                    for (; midx >= 0; midx--) {
                        String linek = lines.get(midx).trim();
                        if (linek.startsWith("public") || linek.startsWith("private") || linek.startsWith("protected") || linek.startsWith("static") || linek.startsWith(baseClassName)) {
                            break;
                        }
                    }
                    ...
                    for (int k = midx - 1; k >= 0; k--) {
                        ...
                        if (linek.startsWith(validatorStr.javadoc)) {
                            ...
                            for (int m = k; m < lines.size(); m++) {
                                ...
                                if (linem.startsWith("* @see") || linem.startsWith("* @since") || linem.startsWith("*/")) {
                                    break;
                                }
                    ...
                    if (!found) {
                        errorCount++;
                        errors.append("L").append(j).append(" : missing '").append(validatorStr.javadoc).append("' for argument validation: ").append(paramName).append("\r\n    ").append(line).append("\r\n at ").append(fullClassName).append(".method(").append(f.getName()).append(":").append(j + 1).append(")\r\n");
                    }
                }
            }
            for (ValidatorStrings validatorStr : EXCEPTION_STRINGS) {
                ...
                if (strIdx >= 0) {
                    ...
                    if (!found) {
                        errorCount++;
                        errors.append("L").append(j).append(" : missing '").append(validatorStr.javadoc).append("' for exception\r\n    ").append(line).append("\r\n at ").append(fullClassName).append(".method(").append(f.getName()).append(":").append(j + 1).append(")\r\n");
                    }
                }
            }
            if (line.startsWith("public") || line.startsWith("protected") || line.startsWith("final") || line.startsWith("private") || line.startsWith("static")) {
                for (ValidatorStrings validatorStr : TYPICAL_ARGUMENT_STRINGS) {
                    ...
                    for (int i = j; i < lines.size(); i++) {
                        ...
                        if (linei.contains(varPattern + ")") || linei.contains(varPattern + ",") || linei.endsWith(varPattern)) {
                            ...
                            if (!linei.matches(".*\\@Nullable\\s.*" + validatorStr.code + ".*")) {
                                ...
                                if (!found) {
                                    errorCount++;
                                    errors.append("L").append(j).append(" : missing '").append(validatorStr.javadoc).append("' for typical argument: ").append(validatorStr.code).append("\r\n    ").append(line).append("\r\n at ").append(fullClassName).append(".method(").append(f.getName()).append(":").append(j + 1).append(")\r\n");
                                }
                            }
                        }
    ...
    public static class myBenchmark extends JU2JmhBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkConnectableObservable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkConnectableObservable, this.description("checkConnectableObservable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkConnectableFlowable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkConnectableFlowable, this.description("checkConnectableFlowable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSubject, this.description("checkSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkFlowableProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkFlowableProcessor, this.description("checkFlowableProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkDisposable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkDisposable, this.description("checkDisposable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkScheduler, this.description("checkScheduler"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSchedulers() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSchedulers, this.description("checkSchedulers"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkAsyncSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkAsyncSubject, this.description("checkAsyncSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkBehaviorSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkBehaviorSubject, this.description("checkBehaviorSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkPublishSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkPublishSubject, this.description("checkPublishSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkReplaySubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkReplaySubject, this.description("checkReplaySubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkUnicastSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkUnicastSubject, this.description("checkUnicastSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkSingleSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkSingleSubject, this.description("checkSingleSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkMaybeSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkMaybeSubject, this.description("checkMaybeSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkCompletableSubject() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkCompletableSubject, this.description("checkCompletableSubject"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkAsyncProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkAsyncProcessor, this.description("checkAsyncProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkBehaviorProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkBehaviorProcessor, this.description("checkBehaviorProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkPublishProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkPublishProcessor, this.description("checkPublishProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkReplayProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkReplayProcessor, this.description("checkReplayProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkUnicastProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkUnicastProcessor, this.description("checkUnicastProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkMulticastProcessor() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkMulticastProcessor, this.description("checkMulticastProcessor"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_checkCompositeDisposable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::checkCompositeDisposable, this.description("checkCompositeDisposable"));
        }

        private ParamValidationNaming implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ParamValidationNaming();
        }

        @java.lang.Override
        public ParamValidationNaming implementation() {
