 ...
 */
public class TestObserverEx<T> extends BaseTestConsumerEx<T, TestObserverEx<T>> implements Observer<T>, Disposable, MaybeObserver<T>, SingleObserver<T>, CompletableObserver {
