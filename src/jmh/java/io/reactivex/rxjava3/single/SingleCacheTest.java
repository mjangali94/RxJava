...
public class SingleCacheTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_delayedDisposed() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delayedDisposed, this.description("delayedDisposed"));
        }
