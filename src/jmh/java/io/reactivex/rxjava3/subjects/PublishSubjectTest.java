...
public class PublishSubjectTest extends SubjectTest<Integer> {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.subjects.SubjectTest._Benchmark {
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_addTerminateRance() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::addTerminateRance, this.description("addTerminateRance"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_addCompleteRance() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::addCompleteRance, this.description("addCompleteRance"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_subscribeToAfterComplete() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::subscribeToAfterComplete, this.description("subscribeToAfterComplete"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_subscribedTo() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::subscribedTo, this.description("subscribedTo"));
        }

        private PublishSubjectTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new PublishSubjectTest();
        }

        @java.lang.Override
        public PublishSubjectTest implementation() {
