...
public final class OperatorArgumentNaming {
     ...
     */
    static final Set<Class<?>> BASE_TYPE_SET = new HashSet<>(Arrays.asList(Flowable.class, Publisher.class, Subscriber.class, FlowableSubscriber.class, Observable.class, ObservableSource.class, Observer.class, Maybe.class, MaybeSource.class, MaybeObserver.class, Single.class, SingleSource.class, SingleObserver.class, Completable.class, CompletableSource.class, CompletableObserver.class));
            ...
            for (Method method : clazz.getDeclaredMethods()) {
                if (method.getDeclaringClass() == clazz && method.getParameterCount() != 0) {
                    ...
                    for (Parameter param : method.getParameters()) {
                        ...
                        } else if (BASE_TYPE_SET.contains(type)) {
                            typeName = "BaseType";
                        } else {
                        ...
                        } else if (name.contains("onSuccess")) {
