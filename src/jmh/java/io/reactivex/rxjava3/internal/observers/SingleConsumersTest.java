...
public class SingleConsumersTest implements Consumer<Object> {
    ...
    static <T> Disposable subscribeAutoDispose(Single<T> source, CompositeDisposable composite, Consumer<? super T> onSuccess, Consumer<? super Throwable> onError) {
    ...
    public void badSource() {
        List<Throwable> errors = TestHelper.trackPluginErrors();
        try {
            subscribeAutoDispose(new Single<Integer>() {
