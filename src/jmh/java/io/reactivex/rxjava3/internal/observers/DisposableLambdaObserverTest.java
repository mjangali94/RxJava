...
public class DisposableLambdaObserverTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_disposeCrash() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::disposeCrash, this.description("disposeCrash"));
        }

        private DisposableLambdaObserverTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new DisposableLambdaObserverTest();
        }

        @java.lang.Override
        public DisposableLambdaObserverTest implementation() {
