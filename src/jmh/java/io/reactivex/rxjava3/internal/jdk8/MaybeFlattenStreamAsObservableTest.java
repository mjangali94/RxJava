...
public _Payloads payloads;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlattenStreamAsObservableTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlattenStreamAsObservableTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlattenStreamAsObservableTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new MaybeFlattenStreamAsObservableTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlattenStreamAsObservableTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(MaybeFlattenStreamAsObservableTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(MaybeFlattenStreamAsObservableTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.successJust = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::successJust, "successJust", this);
            this.payloads.successEmpty = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::successEmpty, "successEmpty", this);
            this.payloads.successMany = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::successMany, "successMany", this);
            this.payloads.successManyTake = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::successManyTake, "successManyTake", this);
            this.payloads.empty = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::empty, "empty", this);
            this.payloads.error = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::error, "error", this);
            this.payloads.mapperCrash = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::mapperCrash, "mapperCrash", this);
            this.payloads.dispose = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::dispose, "dispose", this);
            this.payloads.doubleOnSubscribe = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::doubleOnSubscribe, "doubleOnSubscribe", this);
            this.payloads.fusedEmpty = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fusedEmpty, "fusedEmpty", this);
            this.payloads.fusedJust = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fusedJust, "fusedJust", this);
            this.payloads.fusedMany = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fusedMany, "fusedMany", this);
            this.payloads.fusedManyRejected = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fusedManyRejected, "fusedManyRejected", this);
            this.payloads.fusedStreamAvailableLater = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fusedStreamAvailableLater, "fusedStreamAvailableLater", this);
            this.payloads.fused = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fused, "fused", this);
            this.payloads.fused2 = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::fused2, "fused2", this);
            this.payloads.streamCloseCrash = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::streamCloseCrash, "streamCloseCrash", this);
            this.payloads.hasNextThrowsInDrain = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::hasNextThrowsInDrain, "hasNextThrowsInDrain", this);
            this.payloads.nextThrowsInDrain = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::nextThrowsInDrain, "nextThrowsInDrain", this);
            this.payloads.cancelAfterHasNextInDrain = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::cancelAfterHasNextInDrain, "cancelAfterHasNextInDrain", this);
            this.payloads.cancelAfterNextInDrain = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::cancelAfterNextInDrain, "cancelAfterNextInDrain", this);
            this.payloads.cancelSuccessRace = _ClassStatement.forPayload(MaybeFlattenStreamAsObservableTest::cancelSuccessRace, "cancelSuccessRace", this);
        }
    }
}
