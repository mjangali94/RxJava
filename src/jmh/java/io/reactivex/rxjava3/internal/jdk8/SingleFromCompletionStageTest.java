...
public class SingleFromCompletionStageTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        private SingleFromCompletionStageTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SingleFromCompletionStageTest();
        }

        @java.lang.Override
        public SingleFromCompletionStageTest implementation() {
