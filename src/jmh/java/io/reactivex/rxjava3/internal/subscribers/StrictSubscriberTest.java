...
public class StrictSubscriberTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_strictMode() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::strictMode, this.description("strictMode"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_normalOnNext() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::normalOnNext, this.description("normalOnNext"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_normalOnNextBackpressured() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::normalOnNextBackpressured, this.description("normalOnNextBackpressured"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_normalOnError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::normalOnError, this.description("normalOnError"));
        }
        ...
        public void benchmark_requestZero() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::requestZero, this.description("requestZero"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_requestNegative() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::requestNegative, this.description("requestNegative"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_cancelAfterOnComplete() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::cancelAfterOnComplete, this.description("cancelAfterOnComplete"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_cancelAfterOnError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::cancelAfterOnError, this.description("cancelAfterOnError"));
        }
        ...
        private StrictSubscriberTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new StrictSubscriberTest();
        }

        @java.lang.Override
        public StrictSubscriberTest implementation() {
