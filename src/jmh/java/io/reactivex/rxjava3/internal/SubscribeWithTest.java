...
public class SubscribeWithTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_withFlowable() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::withFlowable, this.description("withFlowable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withObservable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withObservable, this.description("withObservable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withSingle() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withSingle, this.description("withSingle"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withCompletable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withCompletable, this.description("withCompletable"));
        }

        private SubscribeWithTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SubscribeWithTest();
        }

        @java.lang.Override
        public SubscribeWithTest implementation() {
