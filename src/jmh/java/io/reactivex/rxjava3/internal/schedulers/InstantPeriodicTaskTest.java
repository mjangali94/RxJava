...
public class InstantPeriodicTaskTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_taskCrash() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::taskCrash, this.description("taskCrash"));
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dispose2CurrentThread() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dispose2CurrentThread, this.description("dispose2CurrentThread"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_dispose3() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::dispose3, this.description("dispose3"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_disposeOnCurrentThread() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::disposeOnCurrentThread, this.description("disposeOnCurrentThread"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_firstCancelRace() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::firstCancelRace, this.description("firstCancelRace"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_restCancelRace() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::restCancelRace, this.description("restCancelRace"));
        }

        private InstantPeriodicTaskTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new InstantPeriodicTaskTest();
        }

        @java.lang.Override
        public InstantPeriodicTaskTest implementation() {
