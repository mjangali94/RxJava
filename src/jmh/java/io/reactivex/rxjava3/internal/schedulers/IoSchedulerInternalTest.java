...
public class IoSchedulerInternalTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_expiredQueueEmpty() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::expiredQueueEmpty, this.description("expiredQueueEmpty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_expiredWorkerRemoved() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::expiredWorkerRemoved, this.description("expiredWorkerRemoved"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_noExpiredWorker() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::noExpiredWorker, this.description("noExpiredWorker"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_expireReuseRace() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::expireReuseRace, this.description("expireReuseRace"));
        }

        private IoSchedulerInternalTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new IoSchedulerInternalTest();
        }

        @java.lang.Override
        public IoSchedulerInternalTest implementation() {
