...
public class ObservableSerializeTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private ObservableSerializeTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSerializeTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSerializeTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSerializeTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new ObservableSerializeTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSerializeTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(ObservableSerializeTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(ObservableSerializeTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.singleThreadedBasic = _ClassStatement.forPayload(ObservableSerializeTest::singleThreadedBasic, "singleThreadedBasic", this);
            this.payloads.multiThreadedBasic = _ClassStatement.forPayload(ObservableSerializeTest::multiThreadedBasic, "multiThreadedBasic", this);
            this.payloads.multiThreadedWithNPEFlaky = _ClassStatement.forPayload(ObservableSerializeTest::multiThreadedWithNPEFlaky, "multiThreadedWithNPEFlaky", this);
            this.payloads.multiThreadedWithNPEinMiddleFlaky = _ClassStatement.forPayload(ObservableSerializeTest::multiThreadedWithNPEinMiddleFlaky, "multiThreadedWithNPEinMiddleFlaky", this);
        }
    }
}
