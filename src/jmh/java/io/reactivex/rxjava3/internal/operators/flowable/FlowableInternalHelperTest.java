...
public class FlowableInternalHelperTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_requestMaxEnum() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::requestMaxEnum, this.description("requestMaxEnum"));
        }

        private FlowableInternalHelperTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableInternalHelperTest();
        }

        @java.lang.Override
        public FlowableInternalHelperTest implementation() {
