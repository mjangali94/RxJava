...
public class ObservableFromRunnableTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private ObservableFromRunnableTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableFromRunnableTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableFromRunnableTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableFromRunnableTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new ObservableFromRunnableTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableFromRunnableTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(ObservableFromRunnableTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(ObservableFromRunnableTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.fromRunnable = _ClassStatement.forPayload(ObservableFromRunnableTest::fromRunnable, "fromRunnable", this);
            this.payloads.fromRunnableTwice = _ClassStatement.forPayload(ObservableFromRunnableTest::fromRunnableTwice, "fromRunnableTwice", this);
            this.payloads.fromRunnableInvokesLazy = _ClassStatement.forPayload(ObservableFromRunnableTest::fromRunnableInvokesLazy, "fromRunnableInvokesLazy", this);
            this.payloads.fromRunnableThrows = _ClassStatement.forPayload(ObservableFromRunnableTest::fromRunnableThrows, "fromRunnableThrows", this);
            this.payloads.callable = _ClassStatement.forPayload(ObservableFromRunnableTest::callable, "callable", this);
            this.payloads.noErrorLoss = _ClassStatement.forPayload(ObservableFromRunnableTest::noErrorLoss, "noErrorLoss", this);
            this.payloads.disposedUpfront = _ClassStatement.forPayload(ObservableFromRunnableTest::disposedUpfront, "disposedUpfront", this);
            this.payloads.cancelWhileRunning = _ClassStatement.forPayload(ObservableFromRunnableTest::cancelWhileRunning, "cancelWhileRunning", this);
            this.payloads.asyncFused = _ClassStatement.forPayload(ObservableFromRunnableTest::asyncFused, "asyncFused", this);
            this.payloads.syncFusedRejected = _ClassStatement.forPayload(ObservableFromRunnableTest::syncFusedRejected, "syncFusedRejected", this);
        }
    }
}
