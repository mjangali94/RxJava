...
public class CompletableDoOnTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_successAcceptThrows() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::successAcceptThrows, this.description("successAcceptThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_errorAcceptThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::errorAcceptThrows, this.description("errorAcceptThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_doOnDisposeCalled() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::doOnDisposeCalled, this.description("doOnDisposeCalled"));
        }
        ...
        private CompletableDoOnTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableDoOnTest();
        }

        @java.lang.Override
        public CompletableDoOnTest implementation() {
