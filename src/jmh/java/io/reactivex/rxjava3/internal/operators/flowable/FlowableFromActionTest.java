...
public class FlowableFromActionTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private FlowableFromActionTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromActionTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromActionTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromActionTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new FlowableFromActionTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromActionTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(FlowableFromActionTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(FlowableFromActionTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.fromAction = _ClassStatement.forPayload(FlowableFromActionTest::fromAction, "fromAction", this);
            this.payloads.fromActionTwice = _ClassStatement.forPayload(FlowableFromActionTest::fromActionTwice, "fromActionTwice", this);
            this.payloads.fromActionInvokesLazy = _ClassStatement.forPayload(FlowableFromActionTest::fromActionInvokesLazy, "fromActionInvokesLazy", this);
            this.payloads.fromActionThrows = _ClassStatement.forPayload(FlowableFromActionTest::fromActionThrows, "fromActionThrows", this);
            this.payloads.callable = _ClassStatement.forPayload(FlowableFromActionTest::callable, "callable", this);
            this.payloads.noErrorLoss = _ClassStatement.forPayload(FlowableFromActionTest::noErrorLoss, "noErrorLoss", this);
            this.payloads.disposedUpfront = _ClassStatement.forPayload(FlowableFromActionTest::disposedUpfront, "disposedUpfront", this);
            this.payloads.cancelWhileRunning = _ClassStatement.forPayload(FlowableFromActionTest::cancelWhileRunning, "cancelWhileRunning", this);
            this.payloads.asyncFused = _ClassStatement.forPayload(FlowableFromActionTest::asyncFused, "asyncFused", this);
            this.payloads.syncFusedRejected = _ClassStatement.forPayload(FlowableFromActionTest::syncFusedRejected, "syncFusedRejected", this);
        }
    }
}
