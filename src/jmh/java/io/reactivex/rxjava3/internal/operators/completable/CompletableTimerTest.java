...
public _Payloads payloads;
        ...
        public CompletableTimerTest instance;
        ...
        public void makePayloads() {
            ...
            this.payloads.dispose = _ClassStatement.forPayload(CompletableTimerTest::dispose, "dispose", this);
            this.payloads.timerInterruptible = _ClassStatement.forPayload(CompletableTimerTest::timerInterruptible, "timerInterruptible", this);
        }
    }
}
