...
public class FlowableSkipLastTimedTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_delayErrorMoreWork() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delayErrorMoreWork, this.description("delayErrorMoreWork"));
        }

        private FlowableSkipLastTimedTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableSkipLastTimedTest();
        }

        @java.lang.Override
        public FlowableSkipLastTimedTest implementation() {
