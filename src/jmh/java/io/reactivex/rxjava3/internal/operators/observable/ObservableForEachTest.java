...
public class ObservableForEachTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_forEachWile() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::forEachWile, this.description("forEachWile"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_forEachWileWithError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::forEachWileWithError, this.description("forEachWileWithError"));
        }
        ...
        public void benchmark_whilePredicateThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::whilePredicateThrows, this.description("whilePredicateThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_whileErrorThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::whileErrorThrows, this.description("whileErrorThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_whileCompleteThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::whileCompleteThrows, this.description("whileCompleteThrows"));
        }

        private ObservableForEachTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableForEachTest();
        }

        @java.lang.Override
        public ObservableForEachTest implementation() {
