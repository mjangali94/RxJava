...
public class SingleConcatArrayEagerDelayErrorTest {
    ...
    public static class myBenchmark extends JU2JmhBenchmark {
        ...
        private SingleConcatArrayEagerDelayErrorTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SingleConcatArrayEagerDelayErrorTest();
        }

        @java.lang.Override
        public SingleConcatArrayEagerDelayErrorTest implementation() {
