...
public class ObservableTakeTimedTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_takeTimed() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::takeTimed, this.description("takeTimed"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_takeTimedErrorBeforeTime() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::takeTimedErrorBeforeTime, this.description("takeTimedErrorBeforeTime"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_takeTimedErrorAfterTime() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::takeTimedErrorAfterTime, this.description("takeTimedErrorAfterTime"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_timedDefaultScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::timedDefaultScheduler, this.description("timedDefaultScheduler"));
        }

        private ObservableTakeTimedTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableTakeTimedTest();
        }

        @java.lang.Override
        public ObservableTakeTimedTest implementation() {
