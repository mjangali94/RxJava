...
public class FlowableDoOnRequestTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_unsubscribeHappensAgainstParent() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::unsubscribeHappensAgainstParent, this.description("unsubscribeHappensAgainstParent"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_doRequest() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::doRequest, this.description("doRequest"));
        }

        private FlowableDoOnRequestTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableDoOnRequestTest();
        }

        @java.lang.Override
        public FlowableDoOnRequestTest implementation() {
