...
public class ObservableTimestampTest extends RxJavaTest {
    ...
    public void timeIntervalDefault() {
        ...
        try {
            Observable.range(1, 5).timestamp().map(new Function<Timed<Integer>, Long>() {
    ...
    public void timeIntervalDefaultSchedulerCustomUnit() {
        ...
        try {
            Observable.range(1, 5).timestamp(TimeUnit.SECONDS).map(new Function<Timed<Integer>, Long>() {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        private ObservableTimestampTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableTimestampTest();
        }

        @java.lang.Override
        public ObservableTimestampTest implementation() {
