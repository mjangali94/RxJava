...
public class CompletableUsingTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private CompletableUsingTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<CompletableUsingTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<CompletableUsingTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<CompletableUsingTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new CompletableUsingTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<CompletableUsingTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(CompletableUsingTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(CompletableUsingTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.resourceSupplierThrows = _ClassStatement.forPayload(CompletableUsingTest::resourceSupplierThrows, "resourceSupplierThrows", this);
            this.payloads.errorEager = _ClassStatement.forPayload(CompletableUsingTest::errorEager, "errorEager", this);
            this.payloads.emptyEager = _ClassStatement.forPayload(CompletableUsingTest::emptyEager, "emptyEager", this);
            this.payloads.errorNonEager = _ClassStatement.forPayload(CompletableUsingTest::errorNonEager, "errorNonEager", this);
            this.payloads.emptyNonEager = _ClassStatement.forPayload(CompletableUsingTest::emptyNonEager, "emptyNonEager", this);
            this.payloads.supplierCrashEager = _ClassStatement.forPayload(CompletableUsingTest::supplierCrashEager, "supplierCrashEager", this);
            this.payloads.supplierCrashNonEager = _ClassStatement.forPayload(CompletableUsingTest::supplierCrashNonEager, "supplierCrashNonEager", this);
            this.payloads.supplierAndDisposerCrashEager = _ClassStatement.forPayload(CompletableUsingTest::supplierAndDisposerCrashEager, "supplierAndDisposerCrashEager", this);
            this.payloads.supplierAndDisposerCrashNonEager = _ClassStatement.forPayload(CompletableUsingTest::supplierAndDisposerCrashNonEager, "supplierAndDisposerCrashNonEager", this);
            this.payloads.dispose = _ClassStatement.forPayload(CompletableUsingTest::dispose, "dispose", this);
            this.payloads.disposeCrashes = _ClassStatement.forPayload(CompletableUsingTest::disposeCrashes, "disposeCrashes", this);
            this.payloads.isDisposed = _ClassStatement.forPayload(CompletableUsingTest::isDisposed, "isDisposed", this);
            this.payloads.justDisposerCrashes = _ClassStatement.forPayload(CompletableUsingTest::justDisposerCrashes, "justDisposerCrashes", this);
            this.payloads.emptyDisposerCrashes = _ClassStatement.forPayload(CompletableUsingTest::emptyDisposerCrashes, "emptyDisposerCrashes", this);
            this.payloads.errorDisposerCrash = _ClassStatement.forPayload(CompletableUsingTest::errorDisposerCrash, "errorDisposerCrash", this);
            this.payloads.doubleOnSubscribe = _ClassStatement.forPayload(CompletableUsingTest::doubleOnSubscribe, "doubleOnSubscribe", this);
            this.payloads.successDisposeRace = _ClassStatement.forPayload(CompletableUsingTest::successDisposeRace, "successDisposeRace", this);
            this.payloads.errorDisposeRace = _ClassStatement.forPayload(CompletableUsingTest::errorDisposeRace, "errorDisposeRace", this);
            this.payloads.emptyDisposeRace = _ClassStatement.forPayload(CompletableUsingTest::emptyDisposeRace, "emptyDisposeRace", this);
            this.payloads.eagerDisposeResourceThenDisposeUpstream = _ClassStatement.forPayload(CompletableUsingTest::eagerDisposeResourceThenDisposeUpstream, "eagerDisposeResourceThenDisposeUpstream", this);
            this.payloads.nonEagerDisposeUpstreamThenDisposeResource = _ClassStatement.forPayload(CompletableUsingTest::nonEagerDisposeUpstreamThenDisposeResource, "nonEagerDisposeUpstreamThenDisposeResource", this);
        }
    }
}
