...
public class CompletableSwitchOnNextTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_noDelaySwitch() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::noDelaySwitch, this.description("noDelaySwitch"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_delaySwitch() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delaySwitch, this.description("delaySwitch"));
        }

        private CompletableSwitchOnNextTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableSwitchOnNextTest();
        }

        @java.lang.Override
        public CompletableSwitchOnNextTest implementation() {
