...
public class FlowableTimerTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_timerOnce() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::timerOnce, this.description("timerOnce"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_timerPeriodically() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::timerPeriodically, this.description("timerPeriodically"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_interval() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::interval, this.description("interval"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withMultipleSubscribersStartingAtSameTime() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withMultipleSubscribersStartingAtSameTime, this.description("withMultipleSubscribersStartingAtSameTime"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withMultipleStaggeredSubscribers() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withMultipleStaggeredSubscribers, this.description("withMultipleStaggeredSubscribers"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_withMultipleStaggeredSubscribersAndPublish() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::withMultipleStaggeredSubscribersAndPublish, this.description("withMultipleStaggeredSubscribersAndPublish"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_onceObserverThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::onceObserverThrows, this.description("onceObserverThrows"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_periodicObserverThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::periodicObserverThrows, this.description("periodicObserverThrows"));
        }
        ...
        public void benchmark_backpressureNotReady() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::backpressureNotReady, this.description("backpressureNotReady"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_timerCancelRace() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::timerCancelRace, this.description("timerCancelRace"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_timerDelayZero() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::timerDelayZero, this.description("timerDelayZero"));
        }
        ...
        private FlowableTimerTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableTimerTest();
        }

        @java.lang.Override
        public FlowableTimerTest implementation() {
