...
public class FlowableOnErrorResumeNextViaFunctionTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private FlowableOnErrorResumeNextViaFunctionTest instance;

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_resumeNextWithSynchronousExecution() throws java.lang.Throwable {
            this.payloads.resumeNextWithSynchronousExecution.evaluate();
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_resumeNextWithAsyncExecution() throws java.lang.Throwable {
            this.payloads.resumeNextWithAsyncExecution.evaluate();
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_badOtherSource() throws java.lang.Throwable {
            this.payloads.badOtherSource.evaluate();
        }

        private static class _InstanceStatement extends org.junit.runners.model.Statement {

            private final se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableOnErrorResumeNextViaFunctionTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableOnErrorResumeNextViaFunctionTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableOnErrorResumeNextViaFunctionTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new FlowableOnErrorResumeNextViaFunctionTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableOnErrorResumeNextViaFunctionTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(FlowableOnErrorResumeNextViaFunctionTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(FlowableOnErrorResumeNextViaFunctionTest.class, name);
        ...
        private static class _Payloads {
            ...
            public org.junit.runners.model.Statement resumeNextWithSynchronousExecution;

            public org.junit.runners.model.Statement resumeNextWithAsyncExecution;
            ...
            public org.junit.runners.model.Statement badOtherSource;
        }

        @org.openjdk.jmh.annotations.Setup(org.openjdk.jmh.annotations.Level.Trial)
        public void makePayloads() {
            this.payloads = new _Payloads();
            this.payloads.resumeNextWithSynchronousExecution = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::resumeNextWithSynchronousExecution, "resumeNextWithSynchronousExecution", this);
            this.payloads.resumeNextWithAsyncExecution = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::resumeNextWithAsyncExecution, "resumeNextWithAsyncExecution", this);
            this.payloads.functionThrowsError = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::functionThrowsError, "functionThrowsError", this);
            this.payloads.mapResumeAsyncNext = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::mapResumeAsyncNext, "mapResumeAsyncNext", this);
            this.payloads.backpressure = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::backpressure, "backpressure", this);
            this.payloads.normalBackpressure = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::normalBackpressure, "normalBackpressure", this);
            this.payloads.badOtherSource = _ClassStatement.forPayload(FlowableOnErrorResumeNextViaFunctionTest::badOtherSource, "badOtherSource", this);
        }
    }
}
