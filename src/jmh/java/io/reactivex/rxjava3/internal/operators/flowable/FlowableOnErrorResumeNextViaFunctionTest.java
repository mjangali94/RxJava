...
public class FlowableOnErrorResumeNextViaFunctionTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_resumeNextWithSynchronousExecution() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::resumeNextWithSynchronousExecution, this.description("resumeNextWithSynchronousExecution"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_resumeNextWithAsyncExecution() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::resumeNextWithAsyncExecution, this.description("resumeNextWithAsyncExecution"));
        }
        ...
        public void benchmark_badOtherSource() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::badOtherSource, this.description("badOtherSource"));
        }

        private FlowableOnErrorResumeNextViaFunctionTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableOnErrorResumeNextViaFunctionTest();
        }

        @java.lang.Override
        public FlowableOnErrorResumeNextViaFunctionTest implementation() {
