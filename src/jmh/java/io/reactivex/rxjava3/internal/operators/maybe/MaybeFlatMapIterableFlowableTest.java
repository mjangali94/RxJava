...
public class MaybeFlatMapIterableFlowableTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private MaybeFlatMapIterableFlowableTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlatMapIterableFlowableTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlatMapIterableFlowableTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlatMapIterableFlowableTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new MaybeFlatMapIterableFlowableTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<MaybeFlatMapIterableFlowableTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(MaybeFlatMapIterableFlowableTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(MaybeFlatMapIterableFlowableTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.normal = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::normal, "normal", this);
            this.payloads.emptyIterable = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::emptyIterable, "emptyIterable", this);
            this.payloads.error = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::error, "error", this);
            this.payloads.empty = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::empty, "empty", this);
            this.payloads.backpressure = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::backpressure, "backpressure", this);
            this.payloads.take = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::take, "take", this);
            this.payloads.take2 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::take2, "take2", this);
            this.payloads.fused = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::fused, "fused", this);
            this.payloads.fusedNoSync = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::fusedNoSync, "fusedNoSync", this);
            this.payloads.iteratorCrash = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::iteratorCrash, "iteratorCrash", this);
            this.payloads.hasNextCrash = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::hasNextCrash, "hasNextCrash", this);
            this.payloads.nextCrash = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::nextCrash, "nextCrash", this);
            this.payloads.hasNextCrash2 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::hasNextCrash2, "hasNextCrash2", this);
            this.payloads.async1 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::async1, "async1", this);
            this.payloads.async2 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::async2, "async2", this);
            this.payloads.async3 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::async3, "async3", this);
            this.payloads.async4 = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::async4, "async4", this);
            this.payloads.fusedEmptyCheck = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::fusedEmptyCheck, "fusedEmptyCheck", this);
            this.payloads.hasNextThrowsUnbounded = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::hasNextThrowsUnbounded, "hasNextThrowsUnbounded", this);
            this.payloads.nextThrowsUnbounded = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::nextThrowsUnbounded, "nextThrowsUnbounded", this);
            this.payloads.hasNextThrows = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::hasNextThrows, "hasNextThrows", this);
            this.payloads.nextThrows = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::nextThrows, "nextThrows", this);
            this.payloads.requestBefore = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::requestBefore, "requestBefore", this);
            this.payloads.requestCreateInnerRace = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::requestCreateInnerRace, "requestCreateInnerRace", this);
            this.payloads.cancelCreateInnerRace = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::cancelCreateInnerRace, "cancelCreateInnerRace", this);
            this.payloads.slowPathCancelAfterHasNext = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::slowPathCancelAfterHasNext, "slowPathCancelAfterHasNext", this);
            this.payloads.fastPathCancelAfterHasNext = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::fastPathCancelAfterHasNext, "fastPathCancelAfterHasNext", this);
            this.payloads.badRequest = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::badRequest, "badRequest", this);
            this.payloads.doubleOnSubscribe = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::doubleOnSubscribe, "doubleOnSubscribe", this);
            this.payloads.onSuccessRequestRace = _ClassStatement.forPayload(MaybeFlatMapIterableFlowableTest::onSuccessRequestRace, "onSuccessRequestRace", this);
        }
    }
}
