...
public class CompletableToObservableTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        private CompletableToObservableTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableToObservableTest();
        }

        @java.lang.Override
        public CompletableToObservableTest implementation() {
