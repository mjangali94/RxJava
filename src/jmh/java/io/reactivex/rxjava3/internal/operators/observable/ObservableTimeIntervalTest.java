...
public class ObservableTimeIntervalTest extends RxJavaTest {
    ...
    public void timeInterval() {
        ...
        subject.onNext(3);
        subject.onComplete();
        inOrder.verify(observer, times(1)).onNext(new Timed<>(1, 1000, TIME_UNIT));
        inOrder.verify(observer, times(1)).onNext(new Timed<>(2, 2000, TIME_UNIT));
        inOrder.verify(observer, times(1)).onNext(new Timed<>(3, 3000, TIME_UNIT));
    ...
    public void timeIntervalDefault() {
        ...
        try {
            Observable.range(1, 5).timeInterval().map(new Function<Timed<Integer>, Long>() {
    ...
    public void timeIntervalDefaultSchedulerCustomUnit() {
        ...
        try {
            Observable.range(1, 5).timeInterval(TimeUnit.SECONDS).map(new Function<Timed<Integer>, Long>() {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_timeInterval() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::timeInterval, this.description("timeInterval"));
        }
        ...
        private ObservableTimeIntervalTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableTimeIntervalTest();
        }

        @java.lang.Override
        public ObservableTimeIntervalTest implementation() {
