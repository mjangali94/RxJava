...
public class ObservableDistinctTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_distinctOfNone() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::distinctOfNone, this.description("distinctOfNone"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_distinctOfNoneWithKeySelector() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::distinctOfNoneWithKeySelector, this.description("distinctOfNoneWithKeySelector"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_distinctOfNormalSource() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::distinctOfNormalSource, this.description("distinctOfNormalSource"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_distinctOfNormalSourceWithKeySelector() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::distinctOfNormalSourceWithKeySelector, this.description("distinctOfNormalSourceWithKeySelector"));
        }
        ...
        public void benchmark_fusedClear() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fusedClear, this.description("fusedClear"));
        }
        ...
        public void benchmark_collectionSupplierIsNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::collectionSupplierIsNull, this.description("collectionSupplierIsNull"));
        }
        ...
        private ObservableDistinctTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableDistinctTest();
        }

        @java.lang.Override
        public ObservableDistinctTest implementation() {
