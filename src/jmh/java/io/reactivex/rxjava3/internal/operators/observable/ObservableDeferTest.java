...
public class ObservableDeferTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_deferFunctionThrows() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::deferFunctionThrows, this.description("deferFunctionThrows"));
        }

        private ObservableDeferTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableDeferTest();
        }

        @java.lang.Override
        public ObservableDeferTest implementation() {
