...
public class CompletableTakeUntilTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_consumerDisposes() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::consumerDisposes, this.description("consumerDisposes"));
        }
        ...
        public void benchmark_mainErrorLate() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mainErrorLate, this.description("mainErrorLate"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mainCompleteLate() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mainCompleteLate, this.description("mainCompleteLate"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_otherErrorLate() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::otherErrorLate, this.description("otherErrorLate"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_otherCompleteLate() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::otherCompleteLate, this.description("otherCompleteLate"));
        }

        private CompletableTakeUntilTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableTakeUntilTest();
        }

        @java.lang.Override
        public CompletableTakeUntilTest implementation() {
