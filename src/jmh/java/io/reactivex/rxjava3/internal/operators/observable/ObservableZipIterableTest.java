...
public class ObservableZipIterableTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private ObservableZipIterableTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableZipIterableTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableZipIterableTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableZipIterableTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new ObservableZipIterableTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableZipIterableTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(ObservableZipIterableTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(ObservableZipIterableTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.zipIterableSameSize = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableSameSize, "zipIterableSameSize", this);
            this.payloads.zipIterableEmptyFirstSize = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableEmptyFirstSize, "zipIterableEmptyFirstSize", this);
            this.payloads.zipIterableEmptySecond = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableEmptySecond, "zipIterableEmptySecond", this);
            this.payloads.zipIterableFirstShorter = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableFirstShorter, "zipIterableFirstShorter", this);
            this.payloads.zipIterableSecondShorter = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableSecondShorter, "zipIterableSecondShorter", this);
            this.payloads.zipIterableFirstThrows = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableFirstThrows, "zipIterableFirstThrows", this);
            this.payloads.zipIterableIteratorThrows = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableIteratorThrows, "zipIterableIteratorThrows", this);
            this.payloads.zipIterableHasNextThrows = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableHasNextThrows, "zipIterableHasNextThrows", this);
            this.payloads.zipIterableNextThrows = _ClassStatement.forPayload(ObservableZipIterableTest::zipIterableNextThrows, "zipIterableNextThrows", this);
            this.payloads.take2 = _ClassStatement.forPayload(ObservableZipIterableTest::take2, "take2", this);
            this.payloads.dispose = _ClassStatement.forPayload(ObservableZipIterableTest::dispose, "dispose", this);
            this.payloads.doubleOnSubscribe = _ClassStatement.forPayload(ObservableZipIterableTest::doubleOnSubscribe, "doubleOnSubscribe", this);
            this.payloads.iteratorThrows = _ClassStatement.forPayload(ObservableZipIterableTest::iteratorThrows, "iteratorThrows", this);
            this.payloads.badSource = _ClassStatement.forPayload(ObservableZipIterableTest::badSource, "badSource", this);
        }
    }
}
