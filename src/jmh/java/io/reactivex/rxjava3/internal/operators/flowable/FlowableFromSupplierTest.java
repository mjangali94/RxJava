...
public _Payloads payloads;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromSupplierTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromSupplierTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromSupplierTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new FlowableFromSupplierTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableFromSupplierTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(FlowableFromSupplierTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(FlowableFromSupplierTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.shouldNotInvokeFuncUntilSubscription = _ClassStatement.forPayload(FlowableFromSupplierTest::shouldNotInvokeFuncUntilSubscription, "shouldNotInvokeFuncUntilSubscription", this);
            this.payloads.shouldCallOnNextAndOnCompleted = _ClassStatement.forPayload(FlowableFromSupplierTest::shouldCallOnNextAndOnCompleted, "shouldCallOnNextAndOnCompleted", this);
            this.payloads.shouldCallOnError = _ClassStatement.forPayload(FlowableFromSupplierTest::shouldCallOnError, "shouldCallOnError", this);
            this.payloads.shouldNotDeliverResultIfSubscriberUnsubscribedBeforeEmission = _ClassStatement.forPayload(FlowableFromSupplierTest::shouldNotDeliverResultIfSubscriberUnsubscribedBeforeEmission, "shouldNotDeliverResultIfSubscriberUnsubscribedBeforeEmission", this);
            this.payloads.shouldAllowToThrowCheckedException = _ClassStatement.forPayload(FlowableFromSupplierTest::shouldAllowToThrowCheckedException, "shouldAllowToThrowCheckedException", this);
            this.payloads.fusedFlatMapExecution = _ClassStatement.forPayload(FlowableFromSupplierTest::fusedFlatMapExecution, "fusedFlatMapExecution", this);
            this.payloads.fusedFlatMapExecutionHidden = _ClassStatement.forPayload(FlowableFromSupplierTest::fusedFlatMapExecutionHidden, "fusedFlatMapExecutionHidden", this);
            this.payloads.fusedFlatMapNull = _ClassStatement.forPayload(FlowableFromSupplierTest::fusedFlatMapNull, "fusedFlatMapNull", this);
            this.payloads.fusedFlatMapNullHidden = _ClassStatement.forPayload(FlowableFromSupplierTest::fusedFlatMapNullHidden, "fusedFlatMapNullHidden", this);
            this.payloads.undeliverableUponCancellation = _ClassStatement.forPayload(FlowableFromSupplierTest::undeliverableUponCancellation, "undeliverableUponCancellation", this);
        }
    }
}
