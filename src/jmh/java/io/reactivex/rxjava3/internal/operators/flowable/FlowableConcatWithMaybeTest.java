...
public class FlowableConcatWithMaybeTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private FlowableConcatWithMaybeTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableConcatWithMaybeTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableConcatWithMaybeTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableConcatWithMaybeTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new FlowableConcatWithMaybeTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<FlowableConcatWithMaybeTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(FlowableConcatWithMaybeTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(FlowableConcatWithMaybeTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.normalEmpty = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::normalEmpty, "normalEmpty", this);
            this.payloads.normalNonEmpty = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::normalNonEmpty, "normalNonEmpty", this);
            this.payloads.backpressure = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::backpressure, "backpressure", this);
            this.payloads.mainError = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::mainError, "mainError", this);
            this.payloads.otherError = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::otherError, "otherError", this);
            this.payloads.takeMain = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::takeMain, "takeMain", this);
            this.payloads.cancelOther = _ClassStatement.forPayload(FlowableConcatWithMaybeTest::cancelOther, "cancelOther", this);
        }
    }
}
