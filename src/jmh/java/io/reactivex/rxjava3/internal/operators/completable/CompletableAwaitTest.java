...
public class CompletableAwaitTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_awaitInterrupted() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::awaitInterrupted, this.description("awaitInterrupted"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_awaitTimeoutInterrupted() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::awaitTimeoutInterrupted, this.description("awaitTimeoutInterrupted"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_awaitTimeout() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::awaitTimeout, this.description("awaitTimeout"));
        }

        private CompletableAwaitTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableAwaitTest();
        }

        @java.lang.Override
        public CompletableAwaitTest implementation() {
