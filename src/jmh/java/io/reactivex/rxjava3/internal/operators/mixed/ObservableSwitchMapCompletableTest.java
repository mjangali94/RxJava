...
public class ObservableSwitchMapCompletableTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private ObservableSwitchMapCompletableTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSwitchMapCompletableTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSwitchMapCompletableTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSwitchMapCompletableTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new ObservableSwitchMapCompletableTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableSwitchMapCompletableTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(ObservableSwitchMapCompletableTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(ObservableSwitchMapCompletableTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.normal = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::normal, "normal", this);
            this.payloads.mainError = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::mainError, "mainError", this);
            this.payloads.innerError = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::innerError, "innerError", this);
            this.payloads.switchOver = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::switchOver, "switchOver", this);
            this.payloads.dispose = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::dispose, "dispose", this);
            this.payloads.checkDisposed = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::checkDisposed, "checkDisposed", this);
            this.payloads.checkBadSource = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::checkBadSource, "checkBadSource", this);
            this.payloads.mapperCrash = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::mapperCrash, "mapperCrash", this);
            this.payloads.mapperCancels = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::mapperCancels, "mapperCancels", this);
            this.payloads.onNextInnerCompleteRace = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::onNextInnerCompleteRace, "onNextInnerCompleteRace", this);
            this.payloads.onNextInnerErrorRace = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::onNextInnerErrorRace, "onNextInnerErrorRace", this);
            this.payloads.onErrorInnerErrorRace = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::onErrorInnerErrorRace, "onErrorInnerErrorRace", this);
            this.payloads.innerErrorThenMainError = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::innerErrorThenMainError, "innerErrorThenMainError", this);
            this.payloads.innerErrorDelayed = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::innerErrorDelayed, "innerErrorDelayed", this);
            this.payloads.mainCompletesinnerErrorDelayed = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::mainCompletesinnerErrorDelayed, "mainCompletesinnerErrorDelayed", this);
            this.payloads.mainErrorDelayed = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::mainErrorDelayed, "mainErrorDelayed", this);
            this.payloads.scalarMapperCrash = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::scalarMapperCrash, "scalarMapperCrash", this);
            this.payloads.scalarEmptySource = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::scalarEmptySource, "scalarEmptySource", this);
            this.payloads.scalarSource = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::scalarSource, "scalarSource", this);
            this.payloads.undeliverableUponCancel = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::undeliverableUponCancel, "undeliverableUponCancel", this);
            this.payloads.undeliverableUponCancelDelayError = _ClassStatement.forPayload(ObservableSwitchMapCompletableTest::undeliverableUponCancelDelayError, "undeliverableUponCancelDelayError", this);
        }
    }
}
