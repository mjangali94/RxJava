...
public class CompletableFromSingleTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_fromSingleError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromSingleError, this.description("fromSingleError"));
        }

        private CompletableFromSingleTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new CompletableFromSingleTest();
        }

        @java.lang.Override
        public CompletableFromSingleTest implementation() {
