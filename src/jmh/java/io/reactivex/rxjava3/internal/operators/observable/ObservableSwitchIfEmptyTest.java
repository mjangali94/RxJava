...
public class ObservableSwitchIfEmptyTest extends RxJavaTest {
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_switchShouldTriggerUnsubscribe() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::switchShouldTriggerUnsubscribe, this.description("switchShouldTriggerUnsubscribe"));
        }

        private ObservableSwitchIfEmptyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ObservableSwitchIfEmptyTest();
        }

        @java.lang.Override
        public ObservableSwitchIfEmptyTest implementation() {
