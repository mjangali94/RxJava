...
public class MaybeMergeTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_delayErrorWithMaxConcurrency() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::delayErrorWithMaxConcurrency, this.description("delayErrorWithMaxConcurrency"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_delayErrorWithMaxConcurrencyError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delayErrorWithMaxConcurrencyError, this.description("delayErrorWithMaxConcurrencyError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_delayErrorWithMaxConcurrencyAsync() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delayErrorWithMaxConcurrencyAsync, this.description("delayErrorWithMaxConcurrencyAsync"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_delayErrorWithMaxConcurrencyAsyncError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::delayErrorWithMaxConcurrencyAsyncError, this.description("delayErrorWithMaxConcurrencyAsyncError"));
        }
        ...
        private MaybeMergeTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new MaybeMergeTest();
        }

        @java.lang.Override
        public MaybeMergeTest implementation() {
