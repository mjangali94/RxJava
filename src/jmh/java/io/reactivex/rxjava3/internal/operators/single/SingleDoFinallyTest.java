...
public class SingleDoFinallyTest extends RxJavaTest implements Action {
    ...
    public void normalJust() {
        Single.just(1).doFinally(this).test().assertResult(1);
        assertEquals(1, calls);
    }

    @Test
    public void normalError() {
        Single.error(new TestException()).doFinally(this).test().assertFailure(TestException.class);
        assertEquals(1, calls);
    }
    ...
    public void actionThrows() {
        ...
        try {
            Single.just(1).doFinally(new Action() {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        private SingleDoFinallyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SingleDoFinallyTest();
        }

        @java.lang.Override
        public SingleDoFinallyTest implementation() {
