...
public class FlowableDefaultIfEmptyTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_backpressureEmpty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::backpressureEmpty, this.description("backpressureEmpty"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_backpressureNonEmpty() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::backpressureNonEmpty, this.description("backpressureNonEmpty"));
        }

        private FlowableDefaultIfEmptyTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableDefaultIfEmptyTest();
        }

        @java.lang.Override
        public FlowableDefaultIfEmptyTest implementation() {
