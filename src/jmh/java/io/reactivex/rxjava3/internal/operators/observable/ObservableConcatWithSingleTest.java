...
public class ObservableConcatWithSingleTest extends RxJavaTest {
    ...
    public static class _Benchmark {
        ...
        private ObservableConcatWithSingleTest instance;
        ...
        private static class _InstanceStatement extends org.junit.runners.model.Statement {
            ...
            private final se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableConcatWithSingleTest> payload;

            private final _Benchmark benchmark;

            public _InstanceStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableConcatWithSingleTest> payload, _Benchmark benchmark) {
        ...
        private static class _ClassStatement extends org.junit.runners.model.Statement {
            ...
            private _ClassStatement(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableConcatWithSingleTest> payload, _Benchmark benchmark, org.junit.runner.Description description, org.junit.runners.model.FrameworkMethod frameworkMethod) {
                this.payload = payload;
                this.benchmark = benchmark;
            ...
            @java.lang.Override
            public void evaluate() throws java.lang.Throwable {
                this.benchmark.instance = new ObservableConcatWithSingleTest();
            ...
            public static org.junit.runners.model.Statement forPayload(se.chalmers.ju2jmh.api.ThrowingConsumer<ObservableConcatWithSingleTest> payload, String name, _Benchmark benchmark) {
                org.junit.runner.Description description = se.chalmers.ju2jmh.api.Rules.description(ObservableConcatWithSingleTest.class, name);
                org.junit.runners.model.FrameworkMethod frameworkMethod = se.chalmers.ju2jmh.api.Rules.frameworkMethod(ObservableConcatWithSingleTest.class, name);
        ...
        public void makePayloads() {
            ...
            this.payloads.normal = _ClassStatement.forPayload(ObservableConcatWithSingleTest::normal, "normal", this);
            this.payloads.mainError = _ClassStatement.forPayload(ObservableConcatWithSingleTest::mainError, "mainError", this);
            this.payloads.otherError = _ClassStatement.forPayload(ObservableConcatWithSingleTest::otherError, "otherError", this);
            this.payloads.takeMain = _ClassStatement.forPayload(ObservableConcatWithSingleTest::takeMain, "takeMain", this);
            this.payloads.cancelOther = _ClassStatement.forPayload(ObservableConcatWithSingleTest::cancelOther, "cancelOther", this);
            this.payloads.consumerDisposed = _ClassStatement.forPayload(ObservableConcatWithSingleTest::consumerDisposed, "consumerDisposed", this);
            this.payloads.badSource = _ClassStatement.forPayload(ObservableConcatWithSingleTest::badSource, "badSource", this);
            this.payloads.badSource2 = _ClassStatement.forPayload(ObservableConcatWithSingleTest::badSource2, "badSource2", this);
        }
    }
}
