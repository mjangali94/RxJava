...
public class SingleFromCallableTest extends RxJavaTest {
    ...
    public void fromCallableNull() {
        ...
        }).to(TestHelper.<Integer>testConsumer()).assertFailureAndMessage(NullPointerException.class, "The callable returned a null value");
    }
    ...
    public void fromCallableTwice() {
        ...
        Single.fromCallable(callable).test().assertResult(1);
        assertEquals(1, atomicInteger.get());
        Single.fromCallable(callable).test().assertResult(2);
    ...
    public static class myBenchmark extends io.reactivex.rxjava3.core.RxJavaTest.myBenchmark {
        ...
        public void benchmark_fromCallableValue() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromCallableValue, this.description("fromCallableValue"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromCallableError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromCallableError, this.description("fromCallableError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_fromCallableNull() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::fromCallableNull, this.description("fromCallableNull"));
        }
        ...
        private SingleFromCallableTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new SingleFromCallableTest();
        }

        @java.lang.Override
        public SingleFromCallableTest implementation() {
