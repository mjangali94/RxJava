...
public class FlowableConcatTests extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_concatWithFlowableOfFlowable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concatWithFlowableOfFlowable, this.description("concatWithFlowableOfFlowable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_concatWithIterableOfFlowable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concatWithIterableOfFlowable, this.description("concatWithIterableOfFlowable"));
        }
        ...
        private FlowableConcatTests implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new FlowableConcatTests();
        }

        @java.lang.Override
        public FlowableConcatTests implementation() {
