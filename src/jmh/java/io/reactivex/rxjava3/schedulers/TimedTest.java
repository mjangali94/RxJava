...
public class TimedTest extends RxJavaTest {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_properties() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::properties, this.description("properties"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_hashCodeOf() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::hashCodeOf, this.description("hashCodeOf"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_equalsWith() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::equalsWith, this.description("equalsWith"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toStringOf() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::toStringOf, this.description("toStringOf"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_timeUnitNullFail() throws java.lang.Throwable {
            this.createImplementation();
            this.runExceptionBenchmark(this.implementation()::timeUnitNullFail, this.description("timeUnitNullFail"), java.lang.NullPointerException.class);
        }

        private TimedTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new TimedTest();
        }

        @java.lang.Override
        public TimedTest implementation() {
