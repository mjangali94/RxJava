...
public abstract class AbstractSchedulerTests extends RxJavaTest {
    ...
    public static abstract class _Benchmark extends io.reactivex.rxjava3.core.RxJavaTest._Benchmark {
        ...
        public void benchmark_nestedActions() throws java.lang.Throwable {
            ...
            this.runBenchmark(this.implementation()::nestedActions, this.description("nestedActions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_nestedScheduling() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::nestedScheduling, this.description("nestedScheduling"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sequenceOfActions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::sequenceOfActions, this.description("sequenceOfActions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_sequenceOfDelayedActions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::sequenceOfDelayedActions, this.description("sequenceOfDelayedActions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mixOfDelayedAndNonDelayedActions() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mixOfDelayedAndNonDelayedActions, this.description("mixOfDelayedAndNonDelayedActions"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_recursiveExecution() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::recursiveExecution, this.description("recursiveExecution"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_recursiveExecutionWithDelayTime() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::recursiveExecutionWithDelayTime, this.description("recursiveExecutionWithDelayTime"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_recursiveSchedulerInObservable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::recursiveSchedulerInObservable, this.description("recursiveSchedulerInObservable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_concurrentOnNextFailsValidation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::concurrentOnNextFailsValidation, this.description("concurrentOnNextFailsValidation"));
        }
        ...
        public void benchmark_subscribeOnNestedConcurrency() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::subscribeOnNestedConcurrency, this.description("subscribeOnNestedConcurrency"));
        }
        ...
        public void benchmark_scheduleDirectDelayed() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectDelayed, this.description("scheduleDirectDelayed"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectPeriodic() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectPeriodic, this.description("scheduleDirectPeriodic"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_schedulePeriodicallyDirectZeroPeriod() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::schedulePeriodicallyDirectZeroPeriod, this.description("schedulePeriodicallyDirectZeroPeriod"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_schedulePeriodicallyZeroPeriod() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::schedulePeriodicallyZeroPeriod, this.description("schedulePeriodicallyZeroPeriod"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectDecoratesRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectDecoratesRunnable, this.description("scheduleDirectDecoratesRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectWithDelayDecoratesRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectWithDelayDecoratesRunnable, this.description("scheduleDirectWithDelayDecoratesRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_schedulePeriodicallyDirectDecoratesRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::schedulePeriodicallyDirectDecoratesRunnable, this.description("schedulePeriodicallyDirectDecoratesRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unwrapDefaultPeriodicTask() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::unwrapDefaultPeriodicTask, this.description("unwrapDefaultPeriodicTask"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_unwrapScheduleDirectTask() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::unwrapScheduleDirectTask, this.description("unwrapScheduleDirectTask"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectNullRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectNullRunnable, this.description("scheduleDirectNullRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectWithDelayNullRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectWithDelayNullRunnable, this.description("scheduleDirectWithDelayNullRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_schedulePeriodicallyDirectNullRunnable() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::schedulePeriodicallyDirectNullRunnable, this.description("schedulePeriodicallyDirectNullRunnable"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_scheduleDirectPrint() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::scheduleDirectPrint, this.description("scheduleDirectPrint"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_schedulePrint() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::schedulePrint, this.description("schedulePrint"));
        }
        ...
        @java.lang.Override
        public abstract AbstractSchedulerTests implementation();
    }
}
