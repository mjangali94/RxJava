...
public class ComputationSchedulerTests extends AbstractSchedulerConcurrencyTests {
    ...
    public static class _Benchmark extends io.reactivex.rxjava3.schedulers.AbstractSchedulerConcurrencyTests._Benchmark {
        ...
        public void benchmark_threadSafetyWhenSchedulerIsHoppingBetweenThreads() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::threadSafetyWhenSchedulerIsHoppingBetweenThreads, this.description("threadSafetyWhenSchedulerIsHoppingBetweenThreads"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_computationThreadPool1() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::computationThreadPool1, this.description("computationThreadPool1"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_mergeWithExecutorScheduler() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::mergeWithExecutorScheduler, this.description("mergeWithExecutorScheduler"));
        }
        ...
        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_exceptionFromObservableShouldNotBeSwallowed() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::exceptionFromObservableShouldNotBeSwallowed, this.description("exceptionFromObservableShouldNotBeSwallowed"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_exceptionFromObserverShouldNotBeSwallowed() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::exceptionFromObserverShouldNotBeSwallowed, this.description("exceptionFromObserverShouldNotBeSwallowed"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_periodicTaskShouldStopOnError() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::periodicTaskShouldStopOnError, this.description("periodicTaskShouldStopOnError"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_periodicTaskShouldStopOnError2() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::periodicTaskShouldStopOnError2, this.description("periodicTaskShouldStopOnError2"));
        }

        private ComputationSchedulerTests implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new ComputationSchedulerTests();
        }

        @java.lang.Override
        public ComputationSchedulerTests implementation() {
